...
public class UserDashboardPanel extends JPanel implements PanelLayout {
    ...
    public UserDashboardPanel(final Controller controller) {
        ...
        this.switchUserButton = UIFactory.createButton("Switch Profile", "data/resources/pictures/profile.png",
                25, UIConstants.BLUE, 35, 160,true, false, false, UIConstants.FONT);
        this.editVocabularyButton = UIFactory.createButton("Edit Vocabulary", "data/resources/pictures/edit.png",
        ...
        this.deleteUserButton = UIFactory.createButton("Delete User", "data/resources/pictures/bin.png",
                25, UIConstants.RED, 50, 230, true, true, true, UIConstants.FONT);
        this.configureProfileButton = UIFactory.createButton("Configure Profile", "data/resources/pictures/reset.png",
                25, UIConstants.RED, 50, 230, true, true, true, UIConstants.FONT);
        buildLayout();
    ...
    public void buildLayout() {
        ...
        titlePanel.add(UIFactory.createLabel("WELCOME BACK, " + this.controller.getCurrentUser().getUserName() + "!", UIConstants.TITLE_FONT));
    ...
    private JPanel leftPanel() {
        ...
        leftPanel.add(this.switchUserButton);
        leftPanel.add(Box.createVerticalStrut(20));

        leftPanel.add(UIFactory.createLabel("Account Management", UIConstants.TITLE_FONT));
        leftPanel.add(Box.createVerticalStrut(10));

        JPanel managementPanel = UIFactory.createPanel(new FlowLayout(FlowLayout.CENTER, 15, 15));
        UIFactory.brighter(managementPanel);
        managementPanel.setMaximumSize(new Dimension(500, 100));
        managementPanel.setPreferredSize(new Dimension(500, 100));
        managementPanel.add(this.deleteUserButton);
